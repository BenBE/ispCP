...
# IspCP crontab setup / update - FINISH
...
# IspCP named main configuration setup / update - FINISH
...
# IspCP php main configuration setup / update - FINISH
...
# IspCP httpd main vhost setup / update - FINISH
...
# IspCP awstats vhost setup / update - FINISH
...
# IspCP Postfix setup / update - FINISH
...
# IspCP Courier setup / update - FINISH
...
# IspCP Proftpd setup / update - FINISH
...
#  IspCP Daemon, network setup / update - FINISH
...
# IspCP GUI httpd configuration file Setup / Update - FINISH
# IspCP httpd GUI vhost setup / update
# Build, store and install ispCP GUI vhost configuration file
# Enable the gui vhost
sub setup_gui_httpd {
...
# ispCP GUI php configuration files Setup / Update - FINISH
...
# IspCP Gui named configuration - FINISH
...
# IspCP Gui named cfg file Setup / Update - FINISH
# Add Gui named cfg data in main configuration file
...
# IspCP Gui named dns record's Setup / Update- FINISH
# Building GUI named dns record's file
...
# Starting preinstallation script - FINISH
...
# Starting postinstallation script - FINISH
