...
if (UserIO::GET_isset('delete_id')) && UserIO::GET_Int('delete_id')) {
	if (validate_user_deletion(intval(UserIO::GET_Int('delete_id')))) {
		delete_user(intval(UserIO::GET_Int('delete_id')));
	} else {
		user_goto('manage_users.php');
	}
} else if (UserIO::GET_isset('domain_id') && UserIO::GET_Int('domain_id')) {
	validate_domain_deletion(UserIO::GET_Int('domain_id'));
} else if (UserIO::POST_isset('domain_id')) && UserIO::POST_Int('domain_id'))
	&& UserIO:POST_isset('delete') && UserIO:POST_Int('delete') == 1) {
	delete_domain(UserIO::POST_Int('domain_id'));
} else {
