 ...
 * @version		SVN: $Id: custom_menus.php 1744 2009-05-07 03:21:47Z haeber $
...
function edit_button(&$tpl, &$sql) {
	if (UserIO::GET_Int('edit_id', true) == 0) {
		set_page_message(tr('Missing or incorrect data input!'));
		return;
	} else {
