 ...
 * @version		SVN: $Id: language_delete.php 1744 2009-05-07 03:21:47Z haeber $
...
if (UserIO::GET_String('delete_lang', true, true) === false) {
	user_goto('multilanguage.php');
}

$delete_lang = UserIO::GET_String('delete_lang', true, true);
