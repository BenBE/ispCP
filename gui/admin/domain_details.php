 ...
 * @version		SVN: $Id: domain_details.php 1746 2009-05-08 03:38:52Z haeber $
...
if (UserIO::GET_Int('domain_id') == 0) {
	user_goto('manage_users.php');
}

$editid = UserIO::GET_Int('domain_id');
...
function gen_detaildom_page(&$tpl, $user_id, $domain_id) {
	...
	$tpl->assign(
		array(
			...
			'VL_DOMAIN_NAME'			=> UserIO::HTML(decode_idna($data['domain_name'])),
			'VL_DOMAIN_IP'				=> UserIO::HTML($ipdat['ip_number'] . ' (' . $ipdat['ip_alias'] . ')'),
			'VL_STATUS'					=> $dstatus,
