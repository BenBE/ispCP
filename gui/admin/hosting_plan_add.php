...
function gen_empty_ahp_page(&$tpl) {
	...
	$tpl->assign(
			array(
					...
					'VL_SOFTWAREY'			=> '',
					'VL_SOFTWAREN'			=> Config::getInstance()->get('HTML_CHECKED'),
					'TR_CGI_YES'			=> '',
...
function gen_data_ahp_page(&$tpl) {
	...
	$tpl->assign(
			array(
					...
					'VL_SOFTWAREY'	=> ($hp_allowsoftware == '_yes_') ? Config::getInstance()->get('HTML_CHECKED') : '',
					'VL_SOFTWAREN'	=> ($hp_allowsoftware == '_no_') ? Config::getInstance()->get('HTML_CHECKED') : '',
