 ...
 * @version		SVN: $Id: server_statistic.php 1740 2009-05-06 22:12:01Z haeber $
...
if (UserIO::GET_Int('month') > 0 && UserIO::GET_Int('year') > 0) {
	$year = UserIO::GET_Int('year');
	$month = UserIO::GET_Int('month');
} else if (UserIO::POST_Int('month') > 0 && UserIO::POST_Int('year') > 0) {
