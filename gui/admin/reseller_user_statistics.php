 ...
 * @version		SVN: $Id: reseller_user_statistics.php 1744 2009-05-07 03:21:47Z haeber $
...
if (UserIO::POST_isset('rid') && UserIO::POST_isset('name')) {
	$rid = UserIO::POST_String('rid');
	$name = UserIO::POST_String('name');
	} else if (UserIO::GET_isset('rid') && UserIO::GET_isset('name')) {
	$rid = UserIO::GET_String('rid');
	$name = UserIO::GET_String('name');
}

$year = 0;
$month = 0;

if (UserIO::POST_isset('month') && UserIO::POST_isset('year')) {
...
function generate_page(&$tpl, $reseller_id, $reseller_name) {
	...
	if (UserIO::GET_isset('psi')) {
		$start_index = UserIO::GET_Int('psi');
	} else if (UserIO::POST_isset('psi')) {
		$start_index = UserIO::POST_Int('psi');
	} else {
		$start_index = 0;
	}
