 ...
 * @version		SVN: $Id: settings_lostpassword.php 1744 2009-05-07 03:21:47Z haeber $
...
$tpl->assign(
	array(
		...
		'SUBJECT_VALUE1' => UserIO::HTML($data_1['subject'], true),
		'MESSAGE_VALUE1' => UserIO::HTML($data_1['message']),
		'SUBJECT_VALUE2' => UserIO::HTML($data_2['subject'], true),
