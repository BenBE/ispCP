 ...
 * @version		SVN: $Id: password_change.php 1740 2009-05-06 22:12:01Z haeber $
...
if (UserIO::POST_String('uaction') == 'updt_pass') {
	$curr_pass	= UserIO::POST_String('curr_pass', false, true);
	...
	} else if (!check_udata($_SESSION['user_id'], $curr_pass)) {
		set_page_message(tr('The current password is wrong!'));
	} else {
		$upass = crypt_user_pass($pass);
