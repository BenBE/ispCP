 ...
 * @version		SVN: $Id: protected_areas_delete.php 1744 2009-05-07 03:21:47Z haeber $
...
SQL_QUERY;
	...
	write_log($_SESSION['user_logged'].": deletes protected area with ID: ".UserIO::GET_Int('id'));
