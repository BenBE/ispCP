                    ...
                    <tr>
                      ...
                      <td valign="top"><table width="100%" cellspacing="7">
                          ...
                          <tr>
                            ...
                            <td nowrap="nowrap" class="content3" align="center"><b>{$TR_SUBJECT}</b></td>
                          ...
                          <tr class="hl">
							...
							<td class="{$CONTENT[i]}" nowrap="nowrap" align="left">{$FROM[i]}</td>
...
//-->
						...
						<noscript><a href="ticket_view.php?ticket_id={$ID[i]}&amp;screenwidth=800" class="link"> {$SUBJECT[i]}</a></noscript>
                          </td>
                          ...
                          {/section}
                          <tr>
                            <td colspan="3" nowrap="nowrap"><input name="Submit" type="submit" class="button" onClick="MM_goToURL('parent','ticket_delete.php?delete=closed');return document.MM_returnValue" value="{$TR_DELETE_ALL}" /></td>
