                  ...
                  <td valign="top"><table width="100%" cellspacing="7">
					...
					<tr>
						<td colspan="8" valign="top">
							<form action="manage_software.php" method="post" enctype="multipart/form-data">
					...
					<tr>
                      ...
                      <td nowrap class="content3" align="center" width="80"><b>{TR_SOFTWARE_DOWNLOAD}</b></td>
					  <td nowrap class="content3" align="center" width="80"><b>{TR_SOFTWARE_DELETE}</b></td>
                ...
                <tr>
                  ...
                  <td valign="top"><table width="100%" cellspacing="7">
                    <tr>
                      ...
                      <td nowrap class="content3" align="center" width="80"><b>{TR_SOFTWARE_DOWNLOAD}</b></td>
                      <td nowrap class="content3" align="center" width="80"><b>{TR_SOFTWARE_ACTIVATION}</b></td>
                      <td nowrap class="content3" align="center" width="90"><b>{TR_SOFTWARE_DELETE}</b></td>
                    </tr>
                    <!-- BDP: no_software_list -->
                    <tr>
                      <td colspan="7" class="title"><font color="#FF0000">{NO_SOFTWARE}</font></td>
                    </tr>
                    <!-- EDP: no_software_list -->
                    <!-- BDP: list_software -->
                    <tr>
                      <td nowrap class="content"><img src="{THEME_COLOR_PATH}/images/icons/cd.png" width="16" height="16" align="middle" />&nbsp;<a href="#" class="tt">{TR_NAME}<span class="tooltip"><span class="top">&nbsp;</span><span class="middle">{TR_TOOLTIP}</span><span class="bottom">&nbsp;</span></span></a></td>
					  <td nowrap class="content">{TR_VERSION}</td>
                      <td nowrap class="content">{TR_TYPE}</td>
                    ...
                    <!-- EDP: list_software -->
                    <tr>
                      <td colspan="7" align="right" nowrap class="content3">{TR_SOFTWARE_ACT_COUNT}:&nbsp;<b>{TR_SOFTWARE_ACT_NUM}</b></td>
                    </tr>
                  </table>
                    </td>
                </tr>
                ...
                <tr>
                  ...
                  <td valign="top"><table width="100%" cellspacing="4">
                    ...
                    <tr>
                      ...
                      <td nowrap class="content" align="center" width="100"><a href="reseller_software.php?id={RESELLER_ID}">{RESELLER_SOFTWARE_IN_USE}</a></td>
                    </tr>
                    <!-- EDP: list_reseller -->
                    <tr>
