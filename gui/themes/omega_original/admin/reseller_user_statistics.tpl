                          ...
                          <table width="100%" cellspacing="7">
                            <tr>
                              ...
                              <td><div align="left"><br />
								...
								<a href="reseller__user_statistics.php?psi={$PREV_PSI}&amp;month={$MONTH}&amp;year={$YEAR}"><img src="{$THEME_COLOR_PATH}/images/icons/flip/prev.png" width="20" height="20" border="0" alt="" /></a>
								{else}
								<img src="{$THEME_COLOR_PATH}/images/icons/flip/prev_gray.png" width="20" height="20" border="0" alt="" />
								{/if}
                                &nbsp;
                                {if $NEXT_PSI}
                                <a href="reseller_user_statistics.php?psi={$NEXT_PSI}&amp;month={$MONTH}&amp;year={$YEAR}"><img src="{$THEME_COLOR_PATH}/images/icons/flip/next.png" width="20" height="20" border="0" alt="" /></a>
                                {else}
                              ...
                              <td><div align="right"><br />
								{if $PREV_PSI || $PREV_PSI===0}
                                <a href="reseller_user_statistics.php?psi={$PREV_PSI}&amp;month={$MONTH}&amp;year={$YEAR}"><img src="{$THEME_COLOR_PATH}/images/icons/flip/prev.png" width="20" height="20" border="0" alt="" /></a>
								{else}
                                <img src="{$THEME_COLOR_PATH}/images/icons/flip/prev_gray.png" width="20" height="20" border="0" alt="" />
								{/if}
                                &nbsp;
