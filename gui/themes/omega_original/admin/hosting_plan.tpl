                      ...
                      <td width="35" align="center">&nbsp;</td>
                          ...
                          <tr class="hl">
                            ...
                            <td class="{$CLASS_TYPE_ROW[i]}" width="50" align="center">{$PLAN_NUM[i]}</td>
                      		<td class="{$CLASS_TYPE_ROW[i]}"><a href="../orderpanel/package_info.php?coid={$CUSTOM_ORDERPANEL_ID[i]}&amp;user_id={$ADMIN_ID[i]}&amp;id={$HP_ID[i]}" target="_blank" title="{$PLAN_SHOW[i]}">{$PLAN_NAME[i]}</a></td>
