 ...
 <tr style="height:53px;">
  <td style="width:100%; background-image:url({$THEME_COLOR_PATH}/images/top/menu_top.jpg);padding-left:5px;vertical-align:middle;">
   <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
     <td><img src="{$THEME_COLOR_PATH}/images/icons/{$SIDE_MENU_ICON}" width="32" height="33" alt="" /></td>
     <td><span class="titlemenu">{$SIDE_MENU_TITLE}</span></td>
    </tr>
   </table>
  </td>
 </tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
{section name=i loop=$SUB_ITEM_NAME}
  <tr>
    <td><a href="{$SUB_ITEM_LINK[i]}" target="{$SUB_ITEM_TARGET[i]}" class="submenu">{$SUB_ITEM_NAME[i]}</a></td>
  </tr>
  <tr>
