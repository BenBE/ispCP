 ...
 * @version		SVN: $Id: alias_order.php 1744 2009-05-07 03:21:47Z haeber $
...
} else if (UserIO::GET_String('action') == "activate") {

	if (UserIO::GET_Int('act_id') > 0) {
		$act_id = UserIO::GET_Int('act_id');
	} else {
