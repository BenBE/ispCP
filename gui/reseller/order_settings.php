 ...
 * @version		SVN: $Id: order_settings.php 1740 2009-05-06 22:12:01Z haeber $
...
function save_haf(&$tpl, &$sql) {
	...
	$header = UserIO::POST_Memo('header');
	$footer = UserIO::POST_Memo('footer');
 ...
 *
 */
if (UserIO::POST_Memo('header') !== '' && UserIO::POST_Memo('footer') !== '') {
	save_haf($tpl, $sql);
}
