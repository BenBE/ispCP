 ...
 * @version		SVN: $Id: lostpassword.php 1744 2009-05-07 03:21:47Z haeber $
...
if (UserIO::GET_isset('key')) {
	if (UserIO::GET_String('key') != "") {
		check_input(UserIO::GET_String('key'));
