...
if (!UserIO::GET_isset('id') || !is_numeric(UserIO::GET_Int('id')) || !UserIO::GET_isset('k')) {
...
if (validate_order_key(UserIO::GET_Int('id'), UserIO::GET_String('k'))) {
	confirm_order(UserIO::GET_Int('id'));
